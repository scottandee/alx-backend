...
def get_timezone():
    """This function returns the timezone for
    a particular user
    """
    ...
    if g.user:
        timezone_from_settings = g.user.get("timezone")
        if timezone_from_settings:
            return timezone_from_settings
    return "UTC"
...
def hello():
    ...
    return render_template(
        "index.html", title=home_title, header=home_header,
